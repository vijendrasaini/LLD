...
import design.vending.fnbv2.state.HasMoney;
import design.vending.fnbv2.state.HasProduct;
import design.vending.fnbv2.state.IdleState;
...
public class Main {
    public static void main(String[] args) {
        ...
        MachineStateFactory machineStateFactory = new MachineStateFactory();
        machineStateFactory.register(MachineStatus.IDLE, IdleState::new);
        machineStateFactory.register(MachineStatus.HAS_PRODUCT , HasProduct::new);
        machineStateFactory.register(MachineStatus.HAS_MONEY , HasMoney::new);

        Machine machine = new Machine(inventory, cashReserver, machineStateFactory);
